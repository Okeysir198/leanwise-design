...
export const Input = React.forwardRef(function Input({ size = "md", invalid, className, ...rest }, ref) {
  return <input ref={ref} className={cx("lw-input", size === "sm" && "lw-input-sm", size === "lg" && "lw-input-lg", className)}
