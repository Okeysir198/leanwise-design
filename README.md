...
npm i github:Okeysir198/leanwise-design#v5.10.1
```
...
{
  "registries": {
    "@leanwise": "https://raw.githubusercontent.com/Okeysir198/leanwise-design/v5.10.1/r/{name}.json"
  }
}
```
...
| `review` (+ `-foreground`, `-soft`, `-soft-foreground`, `-border`) | Fifth status, violet: a second-phase / review state |
