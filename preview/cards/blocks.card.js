...
(() => {
  ...
  lwCard("Section cards, state, upload", "Blocks compose stock primitives; they add layout, never new colours.", /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-4 gap-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card *:data-[slot=card]:shadow-xs dark:*:data-[slot=card]:bg-card" }, METRICS.map((m) => /* @__PURE__ */ React.createElement(Card, { key: m.label, className: "@container/card" }, /* @__PURE__ */ React.createElement(CardHeader, null, /* @__PURE__ */ React.createElement(CardDescription, null, m.label), /* @__PURE__ */ React.createElement(CardTitle, { className: "text-2xl font-semibold tabular-nums @[250px]/card:text-3xl" }, m.value), /* @__PURE__ */ React.createElement(CardAction, null, /* @__PURE__ */ React.createElement(Badge, { variant: "outline" }, m.delta))), /* @__PURE__ */ React.createElement(CardFooter, { className: "flex-col items-start gap-1.5 text-sm" }, /* @__PURE__ */ React.createElement("div", { className: "line-clamp-1 flex gap-2 font-medium" }, m.line), /* @__PURE__ */ React.createElement("div", { className: "text-muted-foreground" }, m.note))))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-4" }, /* @__PURE__ */ React.createElement(StateView, { state: "loading" }), /* @__PURE__ */ React.createElement(StateView, { state: "empty", title: "No answers yet", description: "Ask a question to see it here.", action: /* @__PURE__ */ React.createElement(Button, null, "Ask a question") }), /* @__PURE__ */ React.createElement(StateView, { state: "error", description: "The search index is unreachable.", action: /* @__PURE__ */ React.createElement(Button, { variant: "outline" }, "Retry") })), /* @__PURE__ */ React.createElement(FileUpload, { value: FILES, onValueChange: () => {
