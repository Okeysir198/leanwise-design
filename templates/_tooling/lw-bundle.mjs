 ...
 *
 *   node templates/_tooling/lw-bundle.mjs            # write _ds_bundle.js
 *   node templates/_tooling/lw-bundle.mjs --check    # fail when the committed file is stale
 *
 * WHY THIS EXISTS
 * ---------------
 ...
 *
 * PATH ASSUMPTION: ROOT is two levels up — this file lives under `templates/_tooling/`.
 */
...
function entrySource(exposed) {
  ...
  const lines = [
    `/* GENERATED by templates/_tooling/lw-bundle.mjs — the synthetic entry. */`,
...
async function generate() {
  ...
  const meta = {
    format: FORMAT,
    namespace: NAMESPACE,
    generator: "templates/_tooling/lw-bundle.mjs",
