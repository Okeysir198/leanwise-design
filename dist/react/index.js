import { forwardRef, useSyncExternalStore, useEffect, useCallback, useState, useRef } from 'react';
...
var Button = forwardRef(function Button2(props, ref) {
  ...
  const content = /* @__PURE__ */ jsxs(Fragment, { children: [
    children,
    arrow ? /* @__PURE__ */ jsx("span", { className: "arrow", "aria-hidden": "true", children: "\u2192" }) : null
  ] });
  if (as === "a") {
    return /* @__PURE__ */ jsx(
      "a",
...
function Card({
  ...
  const Component = Tag;
  return /* @__PURE__ */ jsx(Component, { className: cls, ...rest, children });
}
...
function Check(props) {
  ...
  return /* @__PURE__ */ jsxs("svg", { ...svg, children: [
...
function Auto(props) {
  ...
  return /* @__PURE__ */ jsxs("svg", { ...svg, children: [
    ...
    /* @__PURE__ */ jsx("path", { d: "M12 3a9 9 0 0 0 0 18z", fill: "currentColor", stroke: "none" })
  ] });
}
function Play(props) {
  const { svg, titleId, title } = base(props);
  return /* @__PURE__ */ jsxs("svg", { ...svg, fill: "currentColor", stroke: "none", children: [
    title ? /* @__PURE__ */ jsx("title", { id: titleId, children: title }) : null,
    /* @__PURE__ */ jsx("polygon", { points: "6 3 20 12 6 21" })
  ] });
}
function Step(props) {
  const { svg, titleId, title } = base(props);
...
function ChevronRight(props) {
  ...
  return /* @__PURE__ */ jsxs("svg", { ...svg, children: [
    title ? /* @__PURE__ */ jsx("title", { id: titleId, children: title }) : null,
    /* @__PURE__ */ jsx("polyline", { points: "9 18 15 12 9 6" })
  ] });
}
var Icon = {
  Check,
      ...
      children: SEGMENTS.map(({ value, label, Icon: Icon2 }) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              showIcons ? /* @__PURE__ */ jsx(Icon2, { size: 14 }) : null,
              showLabels ? /* @__PURE__ */ jsx("span", { children: label }) : null
            ]
          },
          value
        );
...
function CodeSurface({
  ...
  return /* @__PURE__ */ jsx("pre", { className: "lw-code", tabIndex: 0, children: /* @__PURE__ */ jsx("code", { dangerouslySetInnerHTML: { __html: escapeHtml(code ?? "") } }) });
}
function ConsoleHeader({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "lw-console-h", children: [
    /* @__PURE__ */ jsxs("span", { className: "left", children: [
      /* @__PURE__ */ jsxs("span", { className: "lights", "aria-hidden": "true", children: [
        /* @__PURE__ */ jsx("i", {}),
        /* @__PURE__ */ jsx("i", {}),
        /* @__PURE__ */ jsx("i", {})
      ] }),
      filename ? /* @__PURE__ */ jsx("span", { className: "url", children: filename }) : null
    ] }),
    /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 12 }, children: [
      lang ? /* @__PURE__ */ jsx("span", { children: lang }) : null,
      actions
    ] })
  ] });
}
function CodeBlock({
  ...
  if (hasHeader) {
    return /* @__PURE__ */ jsxs("div", { className: ["lw-console", className ?? ""].filter(Boolean).join(" "), children: [
      /* @__PURE__ */ jsx(ConsoleHeader, { filename, lang, actions: headerActions }),
      /* @__PURE__ */ jsx(CodeSurface, { code, highlightedHtml })
    ] });
  }
  return /* @__PURE__ */ jsx(
    CodeSurface,
...
function CodeTabs({
  ...
  return /* @__PURE__ */ jsxs("div", { className: ["lw-console", className ?? ""].filter(Boolean).join(" "), children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "lw-code-tabs", role: "tablist", "aria-label": filename ?? "Code", children: tabs.map((t, i) => {
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        tabIndex: 0,
        children: /* @__PURE__ */ jsx(CodeSurface, { code: current.code, highlightedHtml: current.highlightedHtml })
      }
    )
  ] });
}
function Console({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        (filename || headerActions) && /* @__PURE__ */ jsxs("div", { className: "lw-console-h", children: [
          /* @__PURE__ */ jsxs("span", { className: "left", children: [
            /* @__PURE__ */ jsxs("span", { className: "lights", "aria-hidden": "true", children: [
              /* @__PURE__ */ jsx("i", {}),
              /* @__PURE__ */ jsx("i", {}),
        ...
        /* @__PURE__ */ jsxs("div", { className: "lw-console-body", style: bodyStyle(files != null), children: [
          files != null && /* @__PURE__ */ jsx(
            FileTree,
            {
              files,
          ...
          /* @__PURE__ */ jsx("div", { className: "lw-console-rows", style: { flex: 1, minWidth: 0 }, children })
        ] }),
        showRunRow && /* @__PURE__ */ jsx("div", { className: "lw-console-foot", children: /* @__PURE__ */ jsxs("div", { className: "lw-run-controls", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { children: runLabel })
              ]
            }
          ),
          typeof onStep === "function" && /* @__PURE__ */ jsxs("button", { type: "button", className: "lw-btn lw-btn-ghost", onClick: onStep, children: [
            /* @__PURE__ */ jsx(Step, { size: 14 }),
            /* @__PURE__ */ jsx("span", { children: stepLabel })
          ] }),
          typeof onScrub === "function" && stepCount > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "range",
      ...
      children: files.map((f, i) => {
        ...
        return /* @__PURE__ */ jsxs(
          "li",
          {
            ...
            onKeyDown: (e) => onKeyDown(e, i),
            children: [
              /* @__PURE__ */ jsx(File, { size: 13 }),
              /* @__PURE__ */ jsx("span", { style: { flex: 1, minWidth: 0 }, children: f.label }),
              renderMeta?.(f)
            ]
          },
          f.id
...
function StoryCard({
  ...
  const inner = /* @__PURE__ */ jsxs(Fragment, { children: [
    mark != null ? /* @__PURE__ */ jsx("div", { className: "logo", children: mark }) : /* @__PURE__ */ jsx("div", { className: "logo lw-monogram", "aria-hidden": "true", children: monogram(
      typeof monogramName === "string" ? monogramName : typeof company === "string" ? company : ""
    ) }),
    /* @__PURE__ */ jsxs("div", { className: "body", children: [
      industry ? /* @__PURE__ */ jsx(Eyebrow, { muted: true, className: "lw-mb-3", style: { fontSize: 10 }, children: industry }) : null,
      /* @__PURE__ */ jsx("h3", { children: company }),
      description ? /* @__PURE__ */ jsx("p", { children: description }) : null,
      (kpi || kpiSub) && /* @__PURE__ */ jsxs("div", { className: "meta", children: [
        kpi ? /* @__PURE__ */ jsx("span", { className: "kpi", children: kpi }) : null,
        kpiSub ? /* @__PURE__ */ jsx("span", { className: "kpi-sub", children: typeof kpiSub === "string" ? kpiSub.toUpperCase() : kpiSub }) : null
      ] }),
      status && /* @__PURE__ */ jsx("span", { className: "lw-status-chip", "data-variant": status, children: statusLabel ?? status }),
      hasQuote && quote && /* @__PURE__ */ jsxs("blockquote", { className: "lw-story-quote", children: [
        /* @__PURE__ */ jsx("p", { children: quote.quote }),
        /* @__PURE__ */ jsxs("footer", { children: [
          /* @__PURE__ */ jsx("span", { className: "person", children: quote.person }),
          /* @__PURE__ */ jsx("span", { className: "role", children: quote.role })
        ] })
      ] })
    ] })
  ] });
  if (href) {
    return /* @__PURE__ */ jsx("a", { className: cls, href, onClick, children: inner });
  }
  return /* @__PURE__ */ jsx(
    "div",
    {
    ...
    "div",
    {
      ...
      children: items.map((f, i) => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: cls, children: [
          f.icon ? /* @__PURE__ */ jsx("div", { className: "icon", "aria-hidden": "true", children: f.icon }) : f.num ? /* @__PURE__ */ jsx("div", { className: "num", children: f.num }) : null,
...
function LogoRail({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cls, "aria-label": ariaLabel, children: [
    /* @__PURE__ */ jsx("div", { className: "lw-logo-track", children: items.map((it) => /* @__PURE__ */ jsx(LogoCell, { item: it }, it.id)) }),
    marquee && /* @__PURE__ */ jsx("div", { className: "lw-logo-track", "aria-hidden": "true", children: items.map((it) => /* @__PURE__ */ jsx(LogoCell, { item: it }, `${it.id}-dup`)) })
  ] });
}
function LogoCell({ item }) {
  const inner = item.mark ?? /* @__PURE__ */ jsx("span", { className: "name lw-mono", children: item.name });
  if (item.href) {
    return /* @__PURE__ */ jsx("a", { className: "lw-logo-cell", href: item.href, "aria-label": item.name, children: inner });
  }
  return /* @__PURE__ */ jsx("div", { className: "lw-logo-cell", role: "img", "aria-label": item.name, children: inner });
}
...
function useDeterministicCascade(opts) {
  ...
  const [stepIndex, setStepIndex] = useState(stepCount);
...
export { Auto, Button, Card, Check, ChevronRight, CodeBlock, Console, Cross, Dash, Eyebrow, FeatureGrid, File, Icon, LogoRail, Moon, Play, Step, StoryCard, Sun, ThemeToggle, Warning, useDeterministicCascade, useReveal, useSpotlight, useTheme };
