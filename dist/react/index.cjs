...
function CodeSurface({
  ...
  if (highlightedHtml != null) {
    return /* @__PURE__ */ jsxRuntime.jsx("pre", { className: "lw-code", children: /* @__PURE__ */ jsxRuntime.jsx("code", { dangerouslySetInnerHTML: { __html: highlightedHtml } }) });
  }
...
function FileTree({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("ul", { children: files.map((f, i) => {
