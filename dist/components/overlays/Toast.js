...
function Toast({ tone = "info", label, onClose, children, className, ...rest }) {
  ...
  return (
    ...
    /* @__PURE__ */ jsxs("div", { className: cx("lw-toast", tone !== "info" && tone, className), ...rest, children: [
      ...
      onClose && /* @__PURE__ */ jsx("button", { type: "button", className: "lw-icon-btn", "aria-label": "Dismiss", title: "Dismiss", onClick: onClose, children: /* @__PURE__ */ jsx(Icon, { name: "close", size: 15 }) })
    ] })
  );
}
