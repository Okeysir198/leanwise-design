    ...
    "dialog",
    {
      ...
      children: [
        title && /* @__PURE__ */ jsxs("div", { className: "lw-drawer-head", children: [
          ...
          /* @__PURE__ */ jsx("button", { type: "button", className: "lw-icon-btn", "aria-label": closeLabel, title: closeLabel, onClick: onClose, children: /* @__PURE__ */ jsx(Icon, { name: "close", size: 17 }) })
        ] }),
