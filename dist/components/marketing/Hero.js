...
function Hero({ eyebrow, title, lead, actions, aside, compact, className, children, ...rest }) {
  return /* @__PURE__ */ jsx("section", { className: cx("lw-hero-dark", compact && "lw-hero-compact", className), ...rest, children: /* @__PURE__ */ jsxs("div", { className: "lw-container", children: [
