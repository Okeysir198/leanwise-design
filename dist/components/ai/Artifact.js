  ...
  return /* @__PURE__ */ jsxs("div", { className: cx("lw-artifact", className), ...rest, children: [
    /* @__PURE__ */ jsxs("div", { className: "lw-artifact-head", children: [
      ...
      version != null && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("button", { type: "button", className: "lw-icon-btn", "aria-label": "Previous version", disabled: !canPrev, onClick: onPrevVersion, children: /* @__PURE__ */ jsx(Icon, { name: "chevron-left", size: 15 }) }),
        /* @__PURE__ */ jsxs("span", { className: "lw-artifact-ver", children: [
          "v",
          version,
          versionCount ? " / " + versionCount : ""
        ] }),
        /* @__PURE__ */ jsx("button", { type: "button", className: "lw-icon-btn", "aria-label": "Next version", disabled: !canNext, onClick: onNextVersion, children: /* @__PURE__ */ jsx(Icon, { name: "chevron-right", size: 15 }) })
      ] })
    ] }),
