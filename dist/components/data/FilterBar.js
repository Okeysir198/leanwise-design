...
function FilterBar({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cx("lw-filters", className), role: "group", "aria-label": label, ...rest, children: [
    children,
    ...
    filters.length > 1 && onClear && /* @__PURE__ */ jsx("button", { type: "button", className: "lw-filter-clear", onClick: onClear, children: clearAllLabel })
  ] });
}
