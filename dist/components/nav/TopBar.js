...
function TopBar({ brand, brandHref, logo = false, links = [], actions, linkAs = "a", className, children, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs("header", { className: cx("lw-topbar", className), ...rest, children: [
    ...
    links.length > 0 && /* @__PURE__ */ jsx("nav", { "aria-label": "Primary", children: links.map((l, i) => /* @__PURE__ */ jsx(Link, { href: l.href, "aria-current": l.current ? "page" : void 0, children: l.label }, l.id ?? i)) }),
